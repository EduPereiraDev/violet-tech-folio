...
export function TubelightNavBar({ items, className }: NavBarProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 bg-background/10 border border-purple-500/20 backdrop-blur-lg py-2 px-2 rounded-full shadow-lg shadow-purple-500/10">
        {items.map((item) => {
